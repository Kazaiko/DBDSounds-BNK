...
**Extracted Files** - audio files in BNK format up to version 6.7.2 (private server).<br>
**CharacterDefinitions.md** - additional file to help distinguish character audio IDs.


## Tools Used

* **[FModel](https://github.com/4sval/FModel)** - Unreal Engine Archives Explorer.

## Other

Thanks to Masusder and BrandonItaly.
